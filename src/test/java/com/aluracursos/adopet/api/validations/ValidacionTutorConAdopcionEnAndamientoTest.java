...
class ValidacionTutorConAdopcionEnAndamientoTest {
    ...
    @Test
    void noDeberiaPermitirSolicitudDeAdopcionTutorConAdopcionEnAndamiento() {
        //Arrange
        given(adopcionRepository.existsByMascotaIdAndStatus(dto.idTutor(), StatusAdopcion.ESPERANDO_EVALUACION)).willReturn(true);
    ...
    @Test
    void deberiaPermitirSolicitudDeAdopcionTutorSinAdopcionEmAndamiento() {
        //Arrange
        given(adopcionRepository.existsByMascotaIdAndStatus(dto.idTutor(), StatusAdopcion.ESPERANDO_EVALUACION)).willReturn(false);
